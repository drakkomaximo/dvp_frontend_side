  ...
  return (
    <section className="flex flex-col justify-center items-center">
      <header className="text-center py-8">
        ...
        <h2 className="text-white text-3xl py-4">find diferrents github users profile and you know about their details</h2>
      </header>
      <SearchBar onChange={findUsersByName} value={searchValue} />
      <UsersList items={githubUsersListQuery?.data?.data?.items} isFetching={githubUsersListQuery.isFetching}/>
    </section>
  )
}